...
const ABOUT = `
<p>
  С раннего детства мне было интересно всё что как-то приближенно к <b>IT</b> миру.
  В <b>12 лет</b> я получил свою первую работу администратором в компьютерном клубе.
